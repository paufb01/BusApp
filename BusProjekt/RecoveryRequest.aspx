<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoveryRequest.aspx.cs" Inherits="BusProjekt.RecoveryRequest" %>
    ...
    <div class="container-fluid">
        ...
        <div class="form-content">
            <form id="form1" runat="server">
                <h1 style="color: #2C2C2E;" class="h3 mb-3">Schreiben Sie Ihre Email Bitte</h1>
               ...
               <asp:TextBox ID="txtEmail" Cssclass="form-control mb-3" placeholder="E-Mail" runat="server" required autofocus></asp:TextBox>
                ...
                <div class="d-grid gap-2 mb-3">
                    <asp:Button ID="Weiter" CssClass="btn btn-primary" runat="server" OnClick="Weiter_Click" Text="Weiter" />
                </div>
            </form>
        </div>
    </div>
